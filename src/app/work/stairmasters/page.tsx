        ...
        <div className="flex flex-col mt-[48px] mb-[250px] gap-y-[80px] md:gap-y-[120px]">
           <div className="space-y-[16px]">
            ...
            <div className="flex flex-col space-y-[16px] text-left">
                ...
                <h3 className="text-[20px]">take stair-free accessible routes anywhere on the UCLA campus</h3>
            ...
            <div className="border-t border-neutral-300 dark:border-neutral-300" />
                <div className="grid grid-cols-1 min-[560px]:grid-cols-2 lg:grid-cols-4 gap-x-[48px] gap-y-[20px] sm:gap-y-[48px] text-left">
                    <div>
                    ...
                    <div>
                        ...
                        <p className="text-[16px]">Swift, SwiftUI, <br />Apple MapKit, Git, GitHub
                        </p>
                    </div>
                </div>
